...
Revision ID: b48e9c727ff5
Revises: 
Create Date: 2018-11-05 20:07:36.681229
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['followed_id'], ['patient.id'], ),
    sa.ForeignKeyConstraint(['follower_id'], ['therapist.id'], )
    )
